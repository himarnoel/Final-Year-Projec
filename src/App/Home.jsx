...
const Home = () => {
  return (
    <div className="font-raleway">
      <div className=" flex justify-between py-4 px-20 shadow-md fixed top-0 ">
      ...
      <div className="w-[70rem] mx-auto   px-20 mt-[14rem] grid grid-cols-4 gap-y-10 justify-items-center">
